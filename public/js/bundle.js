...
if (updateUserPassword) updateUserDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var passwordCurrent = document.getElementById('name').value;
  var password = document.getElementById('name').value;
  var passwordConfirm = document.getElementById('email').value;
  (0, _updateSettings.updateSettings)({
