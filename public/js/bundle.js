...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidG9taXdhb2JhbmxhIiwiYSI6ImNrZG94OTVuMzBwYW4zM21xcm53ZHdidW0ifQ.8Ta_QL_5li8qaEp_Fu8n6g';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Thanks for Registering');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your ".concat(type.toUpperCase(), " has been successfully updated"));
            }
...
var stripe = Stripe('pk_test_51HG7bGAdnEx1FnE7QGmJ3kr4Eu0GUaAvxeaPT63lEzrl8PBX2PmSNILphJfIhUboYa2Pk0v5r0zlQ8JsYdHsfaug00WAOBRYPf');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // creatte checkout form and charge client card
...
var bookingButton = document.getElementById('book-tour');
